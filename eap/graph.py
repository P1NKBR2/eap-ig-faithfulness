...
class Graph:
    ...
    def apply_greedy(self, n_edges, reset=True, absolute: bool = True):
        ...
        reverse = absolute  # hsc
        candidate_edges = sorted([edge for edge in self.edges.values() if edge.child.in_graph], key = lambda edge: abs_id(edge.score), reverse=reverse)
